...
def _generate_toml(activities: list[dict[str, object]], gpx_dir: str) -> str:
    ...
    for activity in activities:
        ...
        lines.append('tags = ["garmin"]')
        lines.append(f'notes = "{_escape_toml_string(notes)}"')
...
def sync(garmin_config: GarminConfig, base_path: Path) -> None:
    ...
    toml_content = _generate_toml(activities, garmin_config.gpx_dir)
